...
const NavIcons = () => {
  ...
  return (
    <div className='flex item-center flex-4 gap-4 xl:gap-6 relative'>

      <Image src="/profile.png" alt="profile" width={22} height={22} className="cursor-pointer" onClick={handleProfile} />
      {isProfileOpen && (
        <div className="absolute p-4 rounded-md top-12 left-0 text-sm bg-white shadow-[0-3px_10px_rgb(0,0,0,0.2)] z-20">
      ...
      <div className='relative curson-pointer'>
        <Image src="/cart.png" alt="cart" width={22} height={22} className="cursor-pointer" onClick={() => setIsCartOpen((prev) => !prev)} />
